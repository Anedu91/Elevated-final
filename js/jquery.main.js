...
function initSlickCarousel() {
	...
	jQuery('.choose__slider').slick({
		slidesToScroll: 1,
		rows: 0,
		slidesToShow: 5,
		prevArrow: '<a href="#" class="slick-prev"><span class="icon-chevron-left"></span></a>',
		nextArrow: '<a href="#" class="slick-next"><span class="icon-chevron-right"></span></a>',
		infinite: false,
		responsive: [
			{
				breakpoint: 1440,
...
function initMobileNav() {
		...
		'..767': {
			on: function() {
				jQuery('body').mobileNav({
					menuActiveClass: 'navigation__active',
					menuOpener: '.navigation__opener, .navigation__close',
					hideOnClickOutside: true,
					menuDrop: '.navigation__drop'
				});
			},
			off: function() {
	...
	jQuery('.popup').mobileNav({
		menuActiveClass: 'popup__active',
		menuOpener: '.popup__opener, .popup__close'
	});
	
	jQuery('.speakerdrop').mobileNav({
		menuActiveClass: 'active',
		menuOpener: '.speakerdrop__opener',
		hideOnClickOutside: true,
		menuDrop: '.speakerdrop__list'
	});
}
...
function initbodyClass() {
	jQuery('.popup__opener').click(function(e){
		e.preventDefault();
		jQuery('body').addClass('hide__scroll');
	});
	
	jQuery('.popup__close').click(function(e){
		e.preventDefault();
		jQuery('body').removeClass('hide__scroll');
	});
}
